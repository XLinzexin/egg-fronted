    ...
    render() {
        ...
        return (
            <Header style={{ background: '#fff', padding: 0, height: 65 }} className="custom-theme" >
                ...
                <Menu
                    mode="horizontal"
                    style={{ lineHeight: '64px', float: 'right',background: '#fff', borderBottom:"1px solid #ddd"}}
                    onClick={this.menuClick}
                >
                    <Menu.Item key="full" onClick={this.screenFull} >
                        <Icon type="arrows-alt" onClick={this.screenFull} />
                    </Menu.Item>
                    <SubMenu title={<span className="avatar"><img src={avater} alt="头像" className="avaterImg"/><i className="on bottom b-white" /></span>}>
